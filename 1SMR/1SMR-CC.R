...
# Step 1: Generate the summary statistics for the collider-correction 
## The following dataset is generated from the UKB with genotype data, exposure (AD sleep duration), outcome (HbA1c), age, sex, chip, assessment centre, and 40 genetic principal components, (dilution factor and fasting time were also included in the case of non-fasting glucose)
...
# Step 2 
set.seed(888)
#inport "ExactQ.R" function file (see the uploaded file)
source("ExactQ.R") 
...
##  The SNP applied to collider correction is required a positive BetaXG value obtained in the UKB (i.e., align the effect allele corresponding to the effe t allele with a positive BetaXG value in the sleep trait GWAS)
