weightedIVW = function(BetaXG,BetaYG,seBetaXG,seBetaYG,tol=0.00001){
  ...
  BootVar = function(sims=1000){
    ...
    for(hh in 1:sims){
      ...
      bxg    = rnorm(L,BetaXG,seBetaXG) ; seX = seBetaXG    # The updated part for parametric bootstrap
      byg    = rnorm(L,BetaYG,seBetaYG) ; seY = seBetaYG    # The updated part for parametric bootstrap
      BIV    = byg/bxg
